...
<p>We want everyone to feel comfortable contributing to the Known project.
As such, we want to make sure that we are clear about our rules as a
community with respect to harassment.</p>

<p>This anti-harassment policy has been adapted from the generic conference
    anti-harassment policy, which can be found here:</p>

<a href="http://geekfeminism.wikia.com/index.php?title=Conference_anti-harassment_policy">http://geekfeminism.wikia.com/index.php?title=Conference_anti-harassment_policy</a>

<p>We also encourage you to use and publish the above anti-harassment policy
    for any Known-related events you may choose to run.</p>

<p>As with all aspects of Known, we encourage you to submit suggested changes
    via GitHub: <a href="https://github.com/idno/Known/">https://github.com/idno/Known/</a></p>

<p>If you're wondering about how you can contribute, please see CONTRIBUTING.md,
or go ahead and email us: hello@withknown.com. We'll be delighted to hear from
you.</p>

<h2>The short version</h2>

<p>Known is dedicated to providing a harassment-free community for everyone,
...
<p>If a participant engages in harassing behavior, the core team may take any
...
core team immediately. The core team can always be emailed at hello@withknown.com.</p>

<p>The core team will be happy to help participants contact any appropriate
...
community. We value your contributions.</p>

<h2>Get in touch with the core team</h2>

<ul>
    <li>Generic email:  hello@withknown.com</li>
    <li>Ben Werdmuller: ben@benwerd.com, +1 (510) 283-3321</li>
</ul>